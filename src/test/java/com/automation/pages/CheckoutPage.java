...
public class CheckoutPage extends BasePage{
    ...
    public void verifyPage(){
        ...
        Assert.assertTrue(lastName.isDisplayed(),"last name is missing from checkout page");
        Assert.assertEquals(zipCode.isDisplayed(),true,"zipcode is missing from checkout page");
