...
public class ReviewPage extends BasePage{
    ...
    public void verifyPage() {
        ...
        Assert.assertTrue(itemName.isDisplayed(),"item name is missing from review page");
        Assert.assertTrue(finishBtn.isDisplayed(),"finish button is missing from review page");
